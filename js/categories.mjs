// js/categories.mjs
// Renders subject cards and builds links to quiz.html with category params.
...
function getBase() {
  ...
  const parts = location.pathname.split("/").filter(Boolean); // ["WonderW-Learning", "pages", "categories.html"]
